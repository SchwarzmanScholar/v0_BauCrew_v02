...
import { MapPin, Calendar, Euro, ImageIcon } from "lucide-react"
import type { JobRequestDetail } from "@/lib/types"

interface RequestDetailsCardProps {
  request: JobRequestDetail
}
          ...
          {request.budget > 0 && (
            <div className="flex items-start gap-3 text-sm">
              ...
              <div>
                ...
                <p className="text-muted-foreground">bis {request.budget.toLocaleString("de-DE")} €</p>
              </div>
            </div>
          )}
        </div>
