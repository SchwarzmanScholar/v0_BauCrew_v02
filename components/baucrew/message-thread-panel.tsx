...
export function MessageThreadPanel({ messages, onSendMessage, currentUserId = "customer-1" }: MessageThreadPanelProps) {
    ...
    <div className="flex flex-col h-[600px] border rounded-lg bg-card">
              ...
              <div className={cn("flex flex-col gap-1 max-w-[70%]", isCurrentUser ? "items-end" : "items-start")}>
                <div
                  className={cn(
                    ...
                    isCurrentUser ? "bg-secondary text-secondary-foreground" : "bg-muted text-muted-foreground",
                  )}
                >
      ...
      <div className="border-t p-4">
        ...
        <p className="text-xs text-muted-foreground mt-2">
          Drücken Sie Enter zum Senden, Shift+Enter für Zeilenumbruch
        </p>
      </div>
    </div>
  )
