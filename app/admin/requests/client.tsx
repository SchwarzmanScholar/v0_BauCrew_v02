...
const categoryColors: Record<string, string> = {
  ...
  Schreiner: "bg-yellow-100 text-yellow-800 border-yellow-200",
  Bodenbelag: "bg-indigo-100 text-indigo-800 border-indigo-200",
  Maurer: "bg-stone-100 text-stone-800 border-stone-200",
  Heizung: "bg-orange-100 text-orange-800 border-orange-200",
...
const categories = ["Alle", "Elektriker", "Sanitär", "Maler", "Trockenbau", "Handwerker", "Schreiner"]

interface AdminJobRequestsClientProps {
  initialRequests: AdminJobRequestDetail[]
}

export function AdminJobRequestsClient({ initialRequests }: AdminJobRequestsClientProps) {
  const { toast } = useToast()
  const [requests, setRequests] = useState<AdminJobRequestDetail[]>(initialRequests)
  ...
  const handleClose = (id: string) => {
    ...
    toast({
      ...
      description: "Der Auftrag wurde geschlossen und ist nicht mehr sichtbar.",
    })
  }
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="relative flex-1">
                  ...
                  <Input
                    placeholder="Suche nach Titel, ID oder PLZ..."
                    value={searchQuery}
          ...
          <CardContent className="p-0">
            {filteredRequests.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h3 className="text-lg font-semibold">Keine Aufträge gefunden</h3>
                <p className="text-sm text-muted-foreground mt-1">
                  Versuchen Sie andere Filter oder eine andere Suche.
                </p>
              </div>
            ) : (
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden md:table-cell text-center">Angebote</TableHead>
